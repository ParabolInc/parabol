import {sendPhaseItemNotFoundError, sendReflectionGroupNotFoundError} from 'server/utils/docNotFoundErrors';
...
const moveReflectionGroup = async (reflectionGroupId, retroPhaseItemId, sortOrder, {authToken, dataLoader}) => {
  const r = getRethink();
  const now = new Date();
