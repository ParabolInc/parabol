...
const agendaTasks = () => System.import('universal/modules/teamDashboard/containers/AgendaAndTasks/AgendaAndTasksContainer');
  ...
  return (
    ...
    >
      <Switch>
        ...
        <AsyncRoute exact path={match.path} extraProps={{teamName: team.name}} mod={agendaTasks} />
