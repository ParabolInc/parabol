// flow-typed signature: 8413fc68eb520da620e33b95dde2a471
// flow-typed version: 4c8679a1c4/selenium-webdriver_v3.x.x/flow_>=v0.28.x
...
declare class webdriver$WebDriver {
  ...
  findElement(locator: webdriver$By | Function): webdriver$Promise<webdriver$WebElement>;
  isElementPresent(
...
declare class webdriver$TargetLocator {
  ...
  activeElement(): webdriver$Promise<webdriver$WebElement>;
...
declare module "selenium-webdriver" {
  ...
  declare export var WebElementPromise: Class<webdriver$Promise<webdriver$WebElement>>;
