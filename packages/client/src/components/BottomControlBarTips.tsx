...
import LocalAtmosphere from 'parabol-client/src/modules/demo/LocalAtmosphere'
...
import {BottomControlBarTips_meeting} from 'parabol-client/src/__generated__/BottomControlBarTips_meeting.graphql'
