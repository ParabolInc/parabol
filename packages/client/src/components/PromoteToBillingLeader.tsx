...
import {PromoteToBillingLeader_notification} from 'parabol-client/src/__generated__/PromoteToBillingLeader_notification.graphql'
import defaultOrgAvatar from 'parabol-client/src/styles/theme/images/avatar-organization.svg'
interface Props {
