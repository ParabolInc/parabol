import EmailBorderBottom from 'parabol-server/lib/email/components/SummaryEmail/MeetingSummaryEmail/EmailBorderBottom'
import emailDir from 'parabol-server/lib/email/emailDir'
import {
  emailFontFamily,
  emailPrimaryButtonStyle,
  emailTableBase
} from 'parabol-server/lib/email/styles'
