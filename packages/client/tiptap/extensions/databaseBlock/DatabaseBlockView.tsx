...
import type {DatabaseBlockAttributes} from '../../../shared/tiptap/extensions/DatabaseBlockBase'
...
export const DatabaseBlockView = (props: NodeViewProps) => {
  ...
  const Icon = canonical ? StorageIcon : FileOpenIcon
