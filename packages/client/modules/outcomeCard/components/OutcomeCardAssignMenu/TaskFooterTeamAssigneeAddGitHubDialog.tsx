...
const TaskFooterTeamAssigneeAddGitHubDialog = (props: Props) => {
  ...
  const onAddIntegrationClicked = () => {
    ...
    GitHubClientManager.openOAuth(atmosphere, teamId, {
  ...
  return (
    <StyledDialogContainer>
      <DialogTitle>GitHub integration for {teamName}</DialogTitle>
      <DialogContent>
        <div>
          <StyledTip>
...
export default TaskFooterTeamAssigneeAddGitHubDialog
