...
class ZoomClientManager {
  static SCOPES = Providers.ZOOM_SCOPE
  static openOAuth(
    ...
    const uri = `${serverBaseUrl}/oauth/authorize?client_id=${clientId}&scope=${ZoomClientManager.SCOPES}&state=${providerState}&redirect_uri=${redirectUri}&response_type=code`
