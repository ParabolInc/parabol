...
const TutorialMeetingCard = (props: Props) => {
  ...
  return (
    <>
      <div
        className='m-3 fuzzy-tablet:w-80 w-[calc(100%-24px)] max-w-full shrink-0 cursor-pointer select-none rounded-card bg-surface-card shadow-[var(--shadow-card)] [transition:box-shadow_100ms_cubic-bezier(0,0,.2,1),opacity_300ms_cubic-bezier(0,0,.2,1)] hover:shadow-[var(--shadow-card-hover)]'
        onClick={onOpen}
      >
