...
class ReflectionGroupLegacy extends Component<Props, State> {
  isClosing = false
...
export default createFragmentContainer<PassedProps>(
  (DropTarget as any)(REFLECTION_CARD, reflectionDropSpec, reflectionDropCollect)(
    withAtmosphere(withMutationProps(ReflectionGroupLegacy))
  ),
  {
    meeting: graphql`
      fragment ReflectionGroupLegacy_meeting on RetrospectiveMeeting {
        meetingId: id
    ...
    reflectionGroup: graphql`
      fragment ReflectionGroupLegacy_reflectionGroup on RetroReflectionGroup {
