...
import {LinearRepoSearchFilterMenu_teamMember$key} from '../__generated__/LinearRepoSearchFilterMenu_teamMember.graphql'
...
interface Props {
  ...
  teamMemberRef: LinearRepoSearchFilterMenu_teamMember$key
  menuProps: MenuProps
  menuLabel?: string
}

const LinearRepoSearchFilterMenu = (props: Props) => {
  const {teamMemberRef, menuProps, selectedRepos, onToggleRepo, menuLabel} = props
  const teamMember = useFragment(
    graphql`
      fragment LinearRepoSearchFilterMenu_teamMember on TeamMember {
  ...
  return (
    ...
    >
      ...
      <SearchMenuItem
        placeholder='Search your Linear repos'
...
export default LinearRepoSearchFilterMenu
