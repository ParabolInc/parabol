...
import type {TeamPromptLegacyMeeting_meeting$key} from '~/__generated__/TeamPromptLegacyMeeting_meeting.graphql'
...
import TeamPromptEditablePrompt from './TeamPromptEditablePrompt'
import TeamPromptResponseCard from './TeamPromptResponseCard'
import TeamPromptTopBar from './TeamPromptTopBar'

interface Props {
  meeting: TeamPromptLegacyMeeting_meeting$key
}

const TeamPromptLegacyMeeting = (props: Props) => {
  const {meeting: meetingRef} = props
  const meeting = useFragment(
    graphql`
      fragment TeamPromptLegacyMeeting_meeting on TeamPromptMeeting {
        ...useMeeting_meeting
...
export default TeamPromptLegacyMeeting
