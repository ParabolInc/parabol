...
const MeetingCard = (props: Props) => {
  ...
  const meetingPhaseLabel =
    (meetingPhase && phaseLabelLookup[meetingPhase.phaseType]) || t('MeetingCard.Complete')
  ...
  if (!team) {
    ...
    Sentry.captureException(
      new Error(
        t('MeetingCard.MissingTeamOnMeetingJsonStringifyErrObj', {
  ...
  return (
    ...
    >
      <MeetingImgWrapper>
        ...
        <Link
          to={t('MeetingCard.MeetMeetingId', {
            meetingId
          })}
        >
