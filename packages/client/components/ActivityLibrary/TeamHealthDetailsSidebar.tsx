...
const TeamHealthDetailsSidebar = (props: Props) => {
  ...
  return (
    <div className='sticky bottom-0 flex w-full flex-col border-hairline border-t border-solid bg-surface-card px-4 pt-2 lg:top-0 lg:right-0 lg:h-screen lg:w-96 lg:border-l lg:pt-14'>
      <div className='grow'>
