...
const dragHintAnimation = keyframes`
  0%, 1.5%, 2%, 3.5%, 100% {
    left: 0px;
    top: 0px;
...
const ReflectionCardRoot = styled('div')<{showDragHintAnimation?: boolean}>(
  ({showDragHintAnimation}) => ({
    ...
    animation: showDragHintAnimation ? `${dragHintAnimation}  60s 30s infinite` : undefined
  })
)
