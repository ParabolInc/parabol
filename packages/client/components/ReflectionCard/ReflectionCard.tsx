...
const ReflectionCard = (props: Props) => {
  const {showOriginFooter, meeting, reflection, isClipped, stackCount, showReactji, cardName} = props
  ...
  return (
    <ReflectionCardRoot data-cy={cardName}>
      ...
      {!readOnly && (
        <ReflectionCardDeleteButton deleteButton= {`${cardName}-delete`} meetingId={meetingId} reflectionId={reflectionId} />
      )}
