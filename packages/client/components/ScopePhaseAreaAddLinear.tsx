...
const ScopePhaseAreaAddLinear = (props: Props) => {
  ...
  return (
    <div className='flex h-full flex-col items-center justify-center'>
      <button
        onClick={authLinear}
        className='flex items-center justify-center gap-2 whitespace-pre-wrap rounded bg-white px-4 py-2 text-gray-900 shadow transition-shadow duration-100 hover:shadow-md'
      >
        <LinearSVG />
