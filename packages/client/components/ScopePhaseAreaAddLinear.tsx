...
const ScopePhaseAreaAddLinear = (props: Props) => {
  ...
  return (
    <div className='flex h-full flex-col items-center justify-center'>
      <button
        onClick={authLinear}
        className='flex select-none items-center justify-center gap-2 whitespace-pre-wrap rounded bg-surface-card px-4 py-2 text-fg-primary shadow transition-shadow duration-100 hover:shadow-md'
      >
        <LinearSVG />
