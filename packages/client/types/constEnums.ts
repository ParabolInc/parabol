...
export const enum ExternalLinks {
  ...
  INTEGRATIONS_SUPPORT_JIRASERVER = 'https://www.parabol.co/integrations/jira-server',
  INTEGRATIONS_SUPPORT_MSTEAMS = 'https://www.parabol.co/integrations/msteams',
  INTEGRATIONS_SUPPORT_AZUREDEVOPS = 'https://www.parabol.co/integrations/azure-devops',
  INTEGRATIONS_SUPPORT_SLACK = 'https://www.parabol.co/integrations/slack',
...
export const enum AIExplainer {
  ...
  PREMIUM_DISCUSSION_PROMPT_QUESTION = `Our friendly AI 🤖 is here to help facilitate the discussion by prompting you a question`
}
