...
export interface ITeam {
   ...
   */
  updatedAt: any | null;
  reflectPrompts: Array<ReflectPrompt | null> | null;
...
export type ReflectPrompt = IRetroPhaseItem;
...
export interface IReflectPrompt {
  ...
  /**
   * The type of reflect prompt
   */
  reflectPromptType: ReflectPromptTypeEnum | null;
  ...
  /**
   * foreign key. use the template field
   */
  templateId: string;
 ...
 */
export const enum ReflectPromptTypeEnum {
...
export interface IRetrospectiveMeetingSettings {
   ...
   */
  phaseItems: Array<ReflectPrompt> | null;
