      ...
      >
        <div className='mx-1 flex outline-none'>
          <div
            ...
            className={
              'flex w-full cursor-pointer items-center space-x-2 rounded-md in-data-highlighted:bg-surface-hover px-3 py-2 in-data-highlighted:text-fg-primary text-fg-primary text-sm leading-8 outline-hidden hover:bg-surface-hover! hover:text-fg-primary focus:bg-surface-hover'
            }
          >
