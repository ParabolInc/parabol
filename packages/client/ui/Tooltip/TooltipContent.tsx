  ...
  ({className, children, side, ...props}, ref) => (
    <Portal>
      <Content
        ...
        sideOffset={2}
        className={cn(
          'pointer-events-none z-tooltip animate-scale-in overflow-hidden whitespace-nowrap rounded-xs bg-slate-700 px-2 py-1 text-center font-bold text-white text-xs',
          className
        )}
        {...props}
      >
