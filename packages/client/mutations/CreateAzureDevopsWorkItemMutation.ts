...
const mutation = graphql`
  mutation CreateAzureDevopsWorkItemMutation($organization: ID!, $taskId: ID!, $projectKey: ID!) {
    createAzureDevopsWorkItem(organization: $organization, taskId: $taskId, projectKey: $projectKey) {
      error {
        message
      }
...
const CreateAzureDevopsWorkItemMutation = (
  ...
  return commitMutation<TCreateAzureDevopsWorkItemMutation>(atmosphere, {
    ...
    optimisticUpdater: (store) => {
      ...
      const integration = createProxyRecord(store, 'TaskIntegrationAzureDevops', optimisticIntegration)
