...
import type {PersistJiraSearchQueryMutation as TPersistJiraSearchQueryMutation} from '../__generated__/PersistJiraSearchQueryMutation.graphql'
...
const mutation = graphql`
  mutation PersistJiraSearchQueryMutation($teamId: ID!, $input: JiraSearchQueryInput!) {
    persistJiraSearchQuery(teamId: $teamId, input: $input) {
      ...
      ...PersistJiraSearchQueryMutation_notification @relay(mask: false) @alias
    }
  }
`
