...
const getContactProperty = async (propName) => {
...
const updateContactProperty = async (propObj) => {
  const {name} = propObj
...
const createContactProperty = async (propObj) => {
  const {name} = propObj
...
const createCompanyProperty = async (propObj) => {
