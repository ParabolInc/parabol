...
export type AuthenticationSessionType = 'android' | 'desktop' | 'ios' | 'web'
...
export type CyclePeriod = 'after' | 'before' | 'during'
...
export type DateResolutionType = 'halfYear' | 'month' | 'quarter' | 'year'
...
export type FacetPageSource = 'projects' | 'teamIssues'
...
export type FeedSummarySchedule = 'daily' | 'never' | 'weekly'
...
export type GitAutomationStates = 'draft' | 'merge' | 'mergeable' | 'review' | 'start'
...
export type GithubOrgType = 'organization' | 'user'
...
export type InitiativeStatus = 'Active' | 'Completed' | 'Planned'
...
export type InitiativeUpdateHealthType = 'atRisk' | 'offTrack' | 'onTrack'
...
export type NotificationChannel = 'desktop' | 'email' | 'mobile' | 'slack'
...
export type OAuthClientApprovalStatus = 'approved' | 'denied' | 'requested'
...
/** What type of auth is the domain used for. */
export type OrganizationDomainAuthType = 'general' | 'saml'
...
export type OrganizationInviteStatus = 'accepted' | 'expired' | 'pending'
...
export type ProjectTab = 'documents' | 'issues'
...
export type ProjectUpdateHealthType = 'atRisk' | 'offTrack' | 'onTrack'
...
export type ProjectUpdateReminderFrequency = 'month' | 'never' | 'twoWeeks' | 'week'
...
export type PullRequestReviewTool = 'graphite' | 'source'

/** The status of a pull request. */
export type PullRequestStatus = 'approved' | 'closed' | 'draft' | 'inReview' | 'merged' | 'open'
...
export type PushSubscriptionType = 'apple' | 'appleDevelopment' | 'firebase' | 'web'
...
export type ReleaseChannel = 'beta' | 'development' | 'internal' | 'preRelease' | 'public'
...
export type SemanticSearchResultType = 'document' | 'initiative' | 'issue' | 'project'

export type SendStrategy = 'desktop' | 'desktopAndPush' | 'desktopThenPush' | 'push'
...
export type SlaStatus = 'Breached' | 'Completed' | 'Failed' | 'HighRisk' | 'LowRisk' | 'MediumRisk'
...
export type UserFlagUpdateOperation = 'clear' | 'decr' | 'incr' | 'lock'
...
export type UserRoleType = 'admin' | 'app' | 'guest' | 'user'
...
export type GetTeamsAndProjectsQuery = {
  __typename?: 'Query'
  teams: {
    __typename?: 'TeamConnection'
    edges: Array<{
