...
export type CreateIssueMutationMutation = {__typename?: 'Mutation'} & {
  createIssue?: Maybe<
    {__typename?: 'CreateIssuePayload'} & {
      issue?: Maybe<
        {__typename?: 'Issue'} & Pick<Issue, 'id' | 'number'> & {
...
export type GetRepoInfoQuery = {__typename?: 'Query'} & {
  user?: Maybe<{__typename?: 'User'} & Pick<User, 'id' | 'avatarUrl'>>
  repository?: Maybe<{__typename?: 'Repository'} & Pick<Repository, 'id'>>
}
...
export const CreateIssueMutationDocument: DocumentNode<
  ...
  definitions: [
    {
      ...
      operation: 'mutation',
      name: {kind: 'Name', value: 'createIssueMutation'},
      variableDefinitions: [
        {
...
export const GetRepoInfoDocument: DocumentNode<GetRepoInfoQuery, GetRepoInfoQueryVariables> = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {kind: 'Variable', name: {kind: 'Name', value: 'assigneeLogin'}},
          type: {
            kind: 'NonNullType',
            ...
            arguments: [
              {
                ...
                value: {kind: 'Variable', name: {kind: 'Name', value: 'assigneeLogin'}}
              }
            ],
            selectionSet: {
              kind: 'SelectionSet',
