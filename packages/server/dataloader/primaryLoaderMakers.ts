...
export const meetingTemplates = new LoaderMakerPrimary('MeetingTemplate')
export const templateScales = new LoaderMakerPrimary('TemplateScale')
...
export const templateDimensions = new LoaderMakerPrimary('TemplateDimension')
