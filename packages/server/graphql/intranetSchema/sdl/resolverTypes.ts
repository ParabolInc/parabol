...
export type AgendaItemsStage = DiscussionThreadStage &
  NewMeetingStage & {
...
export type CheckInStage = NewMeetingStage &
...
export type EstimateStage = DiscussionThreadStage &
  NewMeetingStage & {
...
export type NotificationTeamInvitation = Notification &
  TeamNotification & {
...
export type RetroDiscussStage = DiscussionThreadStage &
  NewMeetingStage & {
...
export type TeamPromptResponseStage = DiscussionThreadStage &
  NewMeetingStage & {
...
/** A stage that focuses on a single team member */
export type UpdatesStage = NewMeetingStage &
  NewMeetingTeamMemberStage & {
...
export type ResolversTypes = {
  ...
  DiscussionThreadStage:
    | ResolversTypes['AgendaItemsStage']
    | ResolversTypes['EstimateStage']
    | ResolversTypes['RetroDiscussStage']
    | ResolversTypes['TeamPromptResponseStage']
  ...
  EnableSAMLForDomainPayload:
    | ResolversTypes['EnableSAMLForDomainSuccess']
    | ResolversTypes['ErrorPayload']
  ...
  IntegrationProvider:
    | ResolversTypes['IntegrationProviderOAuth1']
    | ResolversTypes['IntegrationProviderOAuth2']
    | ResolversTypes['IntegrationProviderWebhook']
  ...
  MeetingMember:
    | ResolversTypes['ActionMeetingMember']
    | ResolversTypes['PokerMeetingMember']
    | ResolversTypes['RetrospectiveMeetingMember']
    | ResolversTypes['TeamPromptMeetingMember']
  ...
  MessageAllSlackUsersPayload:
    | ResolversTypes['ErrorPayload']
    | ResolversTypes['MessageAllSlackUsersSuccess']
  ...
  NewMeeting:
    | ResolversTypes['ActionMeeting']
    | ResolversTypes['PokerMeeting']
    | ResolversTypes['RetrospectiveMeeting']
    | ResolversTypes['TeamPromptMeeting']
  NewMeetingPhase:
    | ResolversTypes['AgendaItemsPhase']
    | ResolversTypes['CheckInPhase']
    | ResolversTypes['DiscussPhase']
    | ResolversTypes['EstimatePhase']
    | ResolversTypes['GenericMeetingPhase']
    | ResolversTypes['ReflectPhase']
    | ResolversTypes['TeamPromptResponsesPhase']
    | ResolversTypes['UpdatesPhase']
  NewMeetingPhaseTypeEnum: NewMeetingPhaseTypeEnum
  NewMeetingStage:
    | ResolversTypes['AgendaItemsStage']
    | ResolversTypes['CheckInStage']
    | ResolversTypes['EstimateStage']
    | ResolversTypes['GenericMeetingStage']
    | ResolversTypes['RetroDiscussStage']
    | ResolversTypes['TeamPromptResponseStage']
    | ResolversTypes['UpdatesStage']
  ...
  Notification:
    | ResolversTypes['NotificationTeamInvitation']
    | ResolversTypes['NotifyPaymentRejected']
    | ResolversTypes['NotifyPromoteToOrgLeader']
  ...
  Reactable:
    ...
    | ResolversTypes['RetroReflection']
    | ResolversTypes['TeamPromptResponse']
  ...
  RemoveAllSlackAuthsPayload:
    | ResolversTypes['ErrorPayload']
    | ResolversTypes['RemoveAllSlackAuthsSuccess']
  ...
  SuggestedAction:
    | ResolversTypes['SuggestedActionCreateNewTeam']
    | ResolversTypes['SuggestedActionInviteYourTeam']
    | ResolversTypes['SuggestedActionTryActionMeeting']
    | ResolversTypes['SuggestedActionTryRetroMeeting']
    | ResolversTypes['SuggestedActionTryTheDemo']
  ...
  TeamMeetingSettings:
    | ResolversTypes['ActionMeetingSettings']
    | ResolversTypes['PokerMeetingSettings']
    | ResolversTypes['RetrospectiveMeetingSettings']
    | ResolversTypes['TeamPromptMeetingSettings']
  TeamMember: ResolverTypeWrapper<TeamMember>
  TeamMemberIntegrationAuth:
    | ResolversTypes['TeamMemberIntegrationAuthOAuth1']
    | ResolversTypes['TeamMemberIntegrationAuthOAuth2']
    | ResolversTypes['TeamMemberIntegrationAuthWebhook']
  ...
  TierEnum: TierEnum
  TimelineEvent:
    | ResolversTypes['TimelineEventCompletedActionMeeting']
    | ResolversTypes['TimelineEventCompletedRetroMeeting']
    | ResolversTypes['TimelineEventJoinedParabol']
    | ResolversTypes['TimelineEventPokerComplete']
    | ResolversTypes['TimelineEventTeamCreated']
...
export type ResolversParentTypes = {
  ...
  AuthIdentity:
    | ResolversParentTypes['AuthIdentityGoogle']
    | ResolversParentTypes['AuthIdentityLocal']
  ...
  Discussion: Discussion
  DiscussionThreadStage:
    | ResolversParentTypes['AgendaItemsStage']
    | ResolversParentTypes['EstimateStage']
    | ResolversParentTypes['RetroDiscussStage']
    | ResolversParentTypes['TeamPromptResponseStage']
  DomainCountPayload: DomainCountPayload
  DraftEnterpriseInvoicePayload: DraftEnterpriseInvoicePayload
  Email: Scalars['Email']
  EnableSAMLForDomainPayload:
    | ResolversParentTypes['EnableSAMLForDomainSuccess']
    | ResolversParentTypes['ErrorPayload']
  ...
  Int: Scalars['Int']
  IntegrationProvider:
    | ResolversParentTypes['IntegrationProviderOAuth1']
    | ResolversParentTypes['IntegrationProviderOAuth2']
    | ResolversParentTypes['IntegrationProviderWebhook']
  ...
  MeetingMember:
    | ResolversParentTypes['ActionMeetingMember']
    | ResolversParentTypes['PokerMeetingMember']
    | ResolversParentTypes['RetrospectiveMeetingMember']
    | ResolversParentTypes['TeamPromptMeetingMember']
  MeetingTemplate: ResolversParentTypes['PokerTemplate'] | ResolversParentTypes['ReflectTemplate']
  MessageAllSlackUsersPayload:
    | ResolversParentTypes['ErrorPayload']
    | ResolversParentTypes['MessageAllSlackUsersSuccess']
  ...
  NewMeeting:
    | ResolversParentTypes['ActionMeeting']
    | ResolversParentTypes['PokerMeeting']
    | ResolversParentTypes['RetrospectiveMeeting']
    | ResolversParentTypes['TeamPromptMeeting']
  NewMeetingPhase:
    | ResolversParentTypes['AgendaItemsPhase']
    | ResolversParentTypes['CheckInPhase']
    | ResolversParentTypes['DiscussPhase']
    | ResolversParentTypes['EstimatePhase']
    | ResolversParentTypes['GenericMeetingPhase']
    | ResolversParentTypes['ReflectPhase']
    | ResolversParentTypes['TeamPromptResponsesPhase']
    | ResolversParentTypes['UpdatesPhase']
  NewMeetingStage:
    | ResolversParentTypes['AgendaItemsStage']
    | ResolversParentTypes['CheckInStage']
    | ResolversParentTypes['EstimateStage']
    | ResolversParentTypes['GenericMeetingStage']
    | ResolversParentTypes['RetroDiscussStage']
    | ResolversParentTypes['TeamPromptResponseStage']
    | ResolversParentTypes['UpdatesStage']
  NewMeetingTeamMemberStage:
    | ResolversParentTypes['CheckInStage']
    | ResolversParentTypes['UpdatesStage']
  NextPeriodCharges: NextPeriodCharges
  Notification:
    | ResolversParentTypes['NotificationTeamInvitation']
    | ResolversParentTypes['NotifyPaymentRejected']
    | ResolversParentTypes['NotifyPromoteToOrgLeader']
  ...
  Reactable:
    ...
    | ResolversParentTypes['RetroReflection']
    | ResolversParentTypes['TeamPromptResponse']
  Reactji: Reactji
  ...
  RemoveAllSlackAuthsPayload:
    | ResolversParentTypes['ErrorPayload']
    | ResolversParentTypes['RemoveAllSlackAuthsSuccess']
  RemoveAllSlackAuthsSuccess: RemoveAllSlackAuthsSuccess
  RepoIntegration:
    | ResolversParentTypes['JiraRemoteProject']
    | ResolversParentTypes['JiraServerRemoteProject']
  ...
  SuggestedAction:
    | ResolversParentTypes['SuggestedActionCreateNewTeam']
    | ResolversParentTypes['SuggestedActionInviteYourTeam']
    | ResolversParentTypes['SuggestedActionTryActionMeeting']
    | ResolversParentTypes['SuggestedActionTryRetroMeeting']
    | ResolversParentTypes['SuggestedActionTryTheDemo']
  ...
  TeamMeetingSettings:
    | ResolversParentTypes['ActionMeetingSettings']
    | ResolversParentTypes['PokerMeetingSettings']
    | ResolversParentTypes['RetrospectiveMeetingSettings']
    | ResolversParentTypes['TeamPromptMeetingSettings']
  TeamMember: TeamMember
  TeamMemberIntegrationAuth:
    | ResolversParentTypes['TeamMemberIntegrationAuthOAuth1']
    | ResolversParentTypes['TeamMemberIntegrationAuthOAuth2']
    | ResolversParentTypes['TeamMemberIntegrationAuthWebhook']
  ...
  TimelineEvent:
    | ResolversParentTypes['TimelineEventCompletedActionMeeting']
    | ResolversParentTypes['TimelineEventCompletedRetroMeeting']
    | ResolversParentTypes['TimelineEventJoinedParabol']
    | ResolversParentTypes['TimelineEventPokerComplete']
    | ResolversParentTypes['TimelineEventTeamCreated']
  ...
  UpdateWatchlistPayload:
    | ResolversParentTypes['ErrorPayload']
    | ResolversParentTypes['UpdateWatchlistSuccess']
...
export type ActionMeetingResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ActionMeeting'] = ResolversParentTypes['ActionMeeting']
> = {
  agendaItem?: Resolver<
    Maybe<ResolversTypes['AgendaItem']>,
    ParentType,
    ContextType,
    RequireFields<ActionMeetingAgendaItemArgs, 'agendaItemId'>
  >
  ...
  viewerMeetingMember?: Resolver<
    Maybe<ResolversTypes['ActionMeetingMember']>,
    ParentType,
    ContextType
  >
...
export type ActionMeetingMemberResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ActionMeetingMember'] = ResolversParentTypes['ActionMeetingMember']
> = {
...
export type ActionMeetingSettingsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ActionMeetingSettings'] = ResolversParentTypes['ActionMeetingSettings']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  meetingType?: Resolver<ResolversTypes['MeetingTypeEnum'], ParentType, ContextType>
...
export type AddNewFeaturePayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['AddNewFeaturePayload'] = ResolversParentTypes['AddNewFeaturePayload']
> = {
  newFeature?: Resolver<Maybe<ResolversTypes['NewFeatureBroadcast']>, ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type AgendaItemResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['AgendaItem'] = ResolversParentTypes['AgendaItem']
> = {
...
export type AgendaItemsPhaseResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['AgendaItemsPhase'] = ResolversParentTypes['AgendaItemsPhase']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  meetingId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type AgendaItemsStageResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['AgendaItemsStage'] = ResolversParentTypes['AgendaItemsStage']
> = {
...
export type AtlassianIntegrationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['AtlassianIntegration'] = ResolversParentTypes['AtlassianIntegration']
> = {
  ...
  isActive?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>
  issues?: Resolver<
    ResolversTypes['JiraIssueConnection'],
    ParentType,
    ContextType,
    RequireFields<AtlassianIntegrationIssuesArgs, 'first' | 'isJQL'>
  >
  jiraFields?: Resolver<
    Array<ResolversTypes['String']>,
    ParentType,
    ContextType,
    RequireFields<AtlassianIntegrationJiraFieldsArgs, 'cloudId'>
  >
...
export type AtlassianTeamIntegrationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['AtlassianTeamIntegration'] = ResolversParentTypes['AtlassianTeamIntegration']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  jiraDimensionFields?: Resolver<
    Array<ResolversTypes['JiraDimensionField']>,
    ParentType,
    ContextType
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type AuthIdentityResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['AuthIdentity'] = ResolversParentTypes['AuthIdentity']
> = {
...
export type AuthIdentityGoogleResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['AuthIdentityGoogle'] = ResolversParentTypes['AuthIdentityGoogle']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  isEmailVerified?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>
  type?: Resolver<ResolversTypes['AuthIdentityTypeEnum'], ParentType, ContextType>
...
export type AuthIdentityLocalResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['AuthIdentityLocal'] = ResolversParentTypes['AuthIdentityLocal']
> = {
  isEmailVerified?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>
  type?: Resolver<ResolversTypes['AuthIdentityTypeEnum'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type CheckInPhaseResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['CheckInPhase'] = ResolversParentTypes['CheckInPhase']
> = {
...
export type CheckInStageResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['CheckInStage'] = ResolversParentTypes['CheckInStage']
> = {
  endAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  isAsync?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>
...
export type CommentorDetailsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['CommentorDetails'] = ResolversParentTypes['CommentorDetails']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type DisconnectSocketPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['DisconnectSocketPayload'] = ResolversParentTypes['DisconnectSocketPayload']
> = {
  user?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type DiscussPhaseResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['DiscussPhase'] = ResolversParentTypes['DiscussPhase']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  meetingId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  phaseType?: Resolver<ResolversTypes['NewMeetingPhaseTypeEnum'], ParentType, ContextType>
...
> = {
  ...
  teamId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  thread?: Resolver<
    ResolversTypes['ThreadableConnection'],
    ParentType,
    ContextType,
    Partial<DiscussionThreadArgs>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type DiscussionThreadStageResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['DiscussionThreadStage'] = ResolversParentTypes['DiscussionThreadStage']
> = {
  __resolveType: TypeResolveFn<
    'AgendaItemsStage' | 'EstimateStage' | 'RetroDiscussStage' | 'TeamPromptResponseStage',
    ParentType,
    ContextType
  >
  discussion?: Resolver<ResolversTypes['Discussion'], ParentType, ContextType>
...
export type DomainCountPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['DomainCountPayload'] = ResolversParentTypes['DomainCountPayload']
> = {
...
export type DraftEnterpriseInvoicePayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['DraftEnterpriseInvoicePayload'] = ResolversParentTypes['DraftEnterpriseInvoicePayload']
> = {
  error?: Resolver<Maybe<ResolversTypes['StandardMutationError']>, ParentType, ContextType>
...
export type EnableSamlForDomainPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['EnableSAMLForDomainPayload'] = ResolversParentTypes['EnableSAMLForDomainPayload']
> = {
  __resolveType: TypeResolveFn<
    'EnableSAMLForDomainSuccess' | 'ErrorPayload',
    ParentType,
    ContextType
  >
}

export type EnableSamlForDomainSuccessResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['EnableSAMLForDomainSuccess'] = ResolversParentTypes['EnableSAMLForDomainSuccess']
> = {
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type ErrorPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ErrorPayload'] = ResolversParentTypes['ErrorPayload']
> = {
  error?: Resolver<ResolversTypes['StandardMutationError'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type EstimatePhaseResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['EstimatePhase'] = ResolversParentTypes['EstimatePhase']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  meetingId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  phaseType?: Resolver<ResolversTypes['NewMeetingPhaseTypeEnum'], ParentType, ContextType>
...
export type EstimateStageResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['EstimateStage'] = ResolversParentTypes['EstimateStage']
> = {
...
export type EstimateUserScoreResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['EstimateUserScore'] = ResolversParentTypes['EstimateUserScore']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type FlagConversionModalPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['FlagConversionModalPayload'] = ResolversParentTypes['FlagConversionModalPayload']
> = {
  error?: Resolver<Maybe<ResolversTypes['StandardMutationError']>, ParentType, ContextType>
...
export type FlagOverLimitPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['FlagOverLimitPayload'] = ResolversParentTypes['FlagOverLimitPayload']
> = {
  error?: Resolver<Maybe<ResolversTypes['StandardMutationError']>, ParentType, ContextType>
...
export type GenericMeetingPhaseResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['GenericMeetingPhase'] = ResolversParentTypes['GenericMeetingPhase']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  meetingId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  phaseType?: Resolver<ResolversTypes['NewMeetingPhaseTypeEnum'], ParentType, ContextType>
...
export type GenericMeetingStageResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['GenericMeetingStage'] = ResolversParentTypes['GenericMeetingStage']
> = {
  endAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  isAsync?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>
...
export type GitHubIntegrationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['GitHubIntegration'] = ResolversParentTypes['GitHubIntegration']
> = {
  accessToken?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  githubSearchQueries?: Resolver<
    Array<ResolversTypes['GitHubSearchQuery']>,
    ParentType,
    ContextType
  >
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type GitHubSearchQueryResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['GitHubSearchQuery'] = ResolversParentTypes['GitHubSearchQuery']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type GitLabIntegrationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['GitLabIntegration'] = ResolversParentTypes['GitLabIntegration']
> = {
  auth?: Resolver<Maybe<ResolversTypes['TeamMemberIntegrationAuthOAuth2']>, ParentType, ContextType>
  cloudProvider?: Resolver<
    Maybe<ResolversTypes['IntegrationProviderOAuth2']>,
    ParentType,
    ContextType
  >
  sharedProviders?: Resolver<
    Array<ResolversTypes['IntegrationProviderOAuth2']>,
    ParentType,
    ContextType
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type GoogleAnalyzedEntityResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['GoogleAnalyzedEntity'] = ResolversParentTypes['GoogleAnalyzedEntity']
> = {
...
export type IntegrationProviderResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['IntegrationProvider'] = ResolversParentTypes['IntegrationProvider']
> = {
  __resolveType: TypeResolveFn<
    'IntegrationProviderOAuth1' | 'IntegrationProviderOAuth2' | 'IntegrationProviderWebhook',
    ParentType,
    ContextType
  >
  authStrategy?: Resolver<
    ResolversTypes['IntegrationProviderAuthStrategyEnum'],
    ParentType,
    ContextType
  >
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
...
export type IntegrationProviderOAuth1Resolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['IntegrationProviderOAuth1'] = ResolversParentTypes['IntegrationProviderOAuth1']
> = {
  authStrategy?: Resolver<
    ResolversTypes['IntegrationProviderAuthStrategyEnum'],
    ParentType,
...
export type IntegrationProviderOAuth2Resolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['IntegrationProviderOAuth2'] = ResolversParentTypes['IntegrationProviderOAuth2']
> = {
  authStrategy?: Resolver<
    ResolversTypes['IntegrationProviderAuthStrategyEnum'],
    ParentType,
...
export type IntegrationProviderWebhookResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['IntegrationProviderWebhook'] = ResolversParentTypes['IntegrationProviderWebhook']
> = {
  authStrategy?: Resolver<
    ResolversTypes['IntegrationProviderAuthStrategyEnum'],
    ParentType,
...
export type InvoiceConnectionResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['InvoiceConnection'] = ResolversParentTypes['InvoiceConnection']
> = {
...
export type InvoiceEdgeResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['InvoiceEdge'] = ResolversParentTypes['InvoiceEdge']
> = {
...
export type InvoiceLineItemResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['InvoiceLineItem'] = ResolversParentTypes['InvoiceLineItem']
> = {
...
export type InvoiceLineItemDetailsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['InvoiceLineItemDetails'] = ResolversParentTypes['InvoiceLineItemDetails']
> = {
  amount?: Resolver<ResolversTypes['Float'], ParentType, ContextType>
...
export type JiraDimensionFieldResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['JiraDimensionField'] = ResolversParentTypes['JiraDimensionField']
> = {
...
export type JiraIssueResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['JiraIssue'] = ResolversParentTypes['JiraIssue']
> = {
  cloudId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type JiraIssueConnectionResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['JiraIssueConnection'] = ResolversParentTypes['JiraIssueConnection']
> = {
...
export type JiraIssueEdgeResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['JiraIssueEdge'] = ResolversParentTypes['JiraIssueEdge']
> = {
  cursor?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>
...
export type JiraRemoteAvatarUrlsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['JiraRemoteAvatarUrls'] = ResolversParentTypes['JiraRemoteAvatarUrls']
> = {
...
export type JiraRemoteProjectResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['JiraRemoteProject'] = ResolversParentTypes['JiraRemoteProject']
> = {
...
export type JiraRemoteProjectCategoryResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['JiraRemoteProjectCategory'] = ResolversParentTypes['JiraRemoteProjectCategory']
> = {
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type JiraSearchQueryResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['JiraSearchQuery'] = ResolversParentTypes['JiraSearchQuery']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type JiraServerIntegrationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['JiraServerIntegration'] = ResolversParentTypes['JiraServerIntegration']
> = {
  ...
  sharedProviders?: Resolver<
    Array<ResolversTypes['IntegrationProviderOAuth1']>,
    ParentType,
    ContextType
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type JiraServerRemoteProjectResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['JiraServerRemoteProject'] = ResolversParentTypes['JiraServerRemoteProject']
> = {
  avatar?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  avatarUrls?: Resolver<ResolversTypes['JiraRemoteAvatarUrls'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type LoginSamlPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['LoginSAMLPayload'] = ResolversParentTypes['LoginSAMLPayload']
> = {
...
export type LoginsPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['LoginsPayload'] = ResolversParentTypes['LoginsPayload']
> = {
...
export type MassInvitationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['MassInvitation'] = ResolversParentTypes['MassInvitation']
> = {
...
export type MattermostIntegrationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['MattermostIntegration'] = ResolversParentTypes['MattermostIntegration']
> = {
  auth?: Resolver<
    Maybe<ResolversTypes['TeamMemberIntegrationAuthWebhook']>,
    ParentType,
    ContextType
  >
  sharedProviders?: Resolver<
    Array<ResolversTypes['IntegrationProviderWebhook']>,
    ParentType,
    ContextType
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type MeetingGreetingResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['MeetingGreeting'] = ResolversParentTypes['MeetingGreeting']
> = {
  content?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type MeetingMemberResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['MeetingMember'] = ResolversParentTypes['MeetingMember']
> = {
  __resolveType: TypeResolveFn<
    | 'ActionMeetingMember'
    | 'PokerMeetingMember'
...
export type MeetingTemplateResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['MeetingTemplate'] = ResolversParentTypes['MeetingTemplate']
> = {
...
export type MessageAllSlackUsersPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['MessageAllSlackUsersPayload'] = ResolversParentTypes['MessageAllSlackUsersPayload']
> = {
  __resolveType: TypeResolveFn<
    'ErrorPayload' | 'MessageAllSlackUsersSuccess',
    ParentType,
    ContextType
  >
}

export type MessageAllSlackUsersSuccessResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['MessageAllSlackUsersSuccess'] = ResolversParentTypes['MessageAllSlackUsersSuccess']
> = {
...
export type MessageSlackUserErrorResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['MessageSlackUserError'] = ResolversParentTypes['MessageSlackUserError']
> = {
...
> = {
  addNewFeature?: Resolver<
    Maybe<ResolversTypes['AddNewFeaturePayload']>,
    ParentType,
    ContextType,
    RequireFields<MutationAddNewFeatureArgs, 'actionButtonCopy' | 'snackbarMessage' | 'url'>
  >
  autopauseUsers?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>
  backupOrganization?: Resolver<
    ResolversTypes['String'],
    ParentType,
    ContextType,
    RequireFields<MutationBackupOrganizationArgs, 'orgIds'>
  >
  checkRethinkPgEquality?: Resolver<
    ResolversTypes['String'],
    ParentType,
    ContextType,
    RequireFields<MutationCheckRethinkPgEqualityArgs, 'tableName'>
  >
  connectSocket?: Resolver<ResolversTypes['User'], ParentType, ContextType>
  disconnectSocket?: Resolver<
    Maybe<ResolversTypes['DisconnectSocketPayload']>,
    ParentType,
    ContextType
  >
  draftEnterpriseInvoice?: Resolver<
    Maybe<ResolversTypes['DraftEnterpriseInvoicePayload']>,
    ParentType,
    ContextType,
    RequireFields<MutationDraftEnterpriseInvoiceArgs, 'orgId' | 'quantity'>
  >
  dumpHeap?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType,
    RequireFields<MutationDumpHeapArgs, 'isDangerous'>
  >
  enableSAMLForDomain?: Resolver<
    ResolversTypes['EnableSAMLForDomainPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationEnableSamlForDomainArgs, 'domains' | 'metadata' | 'name'>
  >
  endOldMeetings?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>
  flagConversionModal?: Resolver<
    Maybe<ResolversTypes['FlagConversionModalPayload']>,
    ParentType,
    ContextType,
    RequireFields<MutationFlagConversionModalArgs, 'active' | 'orgId'>
  >
  flagOverLimit?: Resolver<
    Maybe<ResolversTypes['FlagOverLimitPayload']>,
    ParentType,
    ContextType,
    RequireFields<MutationFlagOverLimitArgs, 'copy' | 'orgId'>
  >
  hardDeleteUser?: Resolver<
    ResolversTypes['DeleteUserPayload'],
    ParentType,
    ContextType,
    Partial<MutationHardDeleteUserArgs>
  >
  lockTeams?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<MutationLockTeamsArgs, 'isPaid' | 'teamIds'>
  >
  loginSAML?: Resolver<
    ResolversTypes['LoginSAMLPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationLoginSamlArgs, 'queryString' | 'samlName'>
  >
  messageAllSlackUsers?: Resolver<
    ResolversTypes['MessageAllSlackUsersPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationMessageAllSlackUsersArgs, 'message'>
  >
  profileCPU?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>
  removeAllSlackAuths?: Resolver<
    ResolversTypes['RemoveAllSlackAuthsPayload'],
    ParentType,
    ContextType
  >
  runScheduledJobs?: Resolver<
    Maybe<ResolversTypes['Int']>,
    ParentType,
    ContextType,
    RequireFields<MutationRunScheduledJobsArgs, 'seconds'>
  >
  sendBatchNotificationEmails?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['String']>>>,
    ParentType,
    ContextType
  >
  sendUpcomingInvoiceEmails?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['String']>>>,
    ParentType,
    ContextType
  >
  setOrganizationDomain?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<MutationSetOrganizationDomainArgs, 'domain' | 'orgId'>
  >
  stripeCreateInvoice?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<MutationStripeCreateInvoiceArgs, 'invoiceId'>
  >
  stripeFailPayment?: Resolver<
    Maybe<ResolversTypes['StripeFailPaymentPayload']>,
    ParentType,
    ContextType,
    RequireFields<MutationStripeFailPaymentArgs, 'invoiceId'>
  >
  stripeInvoiceFinalized?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<MutationStripeInvoiceFinalizedArgs, 'invoiceId'>
  >
  stripeSucceedPayment?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<MutationStripeSucceedPaymentArgs, 'invoiceId'>
  >
  stripeUpdateCreditCard?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<MutationStripeUpdateCreditCardArgs, 'customerId'>
  >
  stripeUpdateInvoiceItem?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<MutationStripeUpdateInvoiceItemArgs, 'invoiceItemId'>
  >
  updateEmail?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateEmailArgs, 'newEmail' | 'oldEmail'>
  >
  updateOAuthRefreshTokens?: Resolver<
    Maybe<ResolversTypes['Int']>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateOAuthRefreshTokensArgs, 'updatedBefore'>
  >
  updateWatchlist?: Resolver<
    ResolversTypes['UpdateWatchlistPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateWatchlistArgs, 'includeInWatchlist'>
  >
}

export type NewFeatureBroadcastResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['NewFeatureBroadcast'] = ResolversParentTypes['NewFeatureBroadcast']
> = {
...
export type NewMeetingResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['NewMeeting'] = ResolversParentTypes['NewMeeting']
> = {
  __resolveType: TypeResolveFn<
    'ActionMeeting' | 'PokerMeeting' | 'RetrospectiveMeeting' | 'TeamPromptMeeting',
    ParentType,
    ContextType
  >
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
...
export type NewMeetingPhaseResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['NewMeetingPhase'] = ResolversParentTypes['NewMeetingPhase']
> = {
  __resolveType: TypeResolveFn<
    | 'AgendaItemsPhase'
    | 'CheckInPhase'
...
export type NewMeetingStageResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['NewMeetingStage'] = ResolversParentTypes['NewMeetingStage']
> = {
  __resolveType: TypeResolveFn<
    | 'AgendaItemsStage'
    | 'CheckInStage'
...
export type NewMeetingTeamMemberStageResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['NewMeetingTeamMemberStage'] = ResolversParentTypes['NewMeetingTeamMemberStage']
> = {
...
export type NextPeriodChargesResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['NextPeriodCharges'] = ResolversParentTypes['NextPeriodCharges']
> = {
  amount?: Resolver<ResolversTypes['Float'], ParentType, ContextType>
...
> = {
  __resolveType: TypeResolveFn<
    'NotificationTeamInvitation' | 'NotifyPaymentRejected' | 'NotifyPromoteToOrgLeader',
    ParentType,
    ContextType
  >
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
...
export type NotificationTeamInvitationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['NotificationTeamInvitation'] = ResolversParentTypes['NotificationTeamInvitation']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type NotifyPaymentRejectedResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['NotifyPaymentRejected'] = ResolversParentTypes['NotifyPaymentRejected']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  organization?: Resolver<ResolversTypes['Organization'], ParentType, ContextType>
...
export type NotifyPromoteToOrgLeaderResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['NotifyPromoteToOrgLeader'] = ResolversParentTypes['NotifyPromoteToOrgLeader']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  organization?: Resolver<ResolversTypes['Organization'], ParentType, ContextType>
...
export type OrgUserCountResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['OrgUserCount'] = ResolversParentTypes['OrgUserCount']
> = {
  activeUserCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
...
> = {
  ...
  organizationUsers?: Resolver<
    ResolversTypes['OrganizationUserConnection'],
    ParentType,
    ContextType,
    Partial<OrganizationOrganizationUsersArgs>
  >
...
export type OrganizationUserResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['OrganizationUser'] = ResolversParentTypes['OrganizationUser']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type OrganizationUserConnectionResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['OrganizationUserConnection'] = ResolversParentTypes['OrganizationUserConnection']
> = {
...
export type OrganizationUserEdgeResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['OrganizationUserEdge'] = ResolversParentTypes['OrganizationUserEdge']
> = {
...
export type PageInfoDateCursorResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['PageInfoDateCursor'] = ResolversParentTypes['PageInfoDateCursor']
> = {
...
export type PingableServicesResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['PingableServices'] = ResolversParentTypes['PingableServices']
> = {
...
export type PokerMeetingResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['PokerMeeting'] = ResolversParentTypes['PokerMeeting']
> = {
  commentCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  createdBy?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  ...
  story?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<PokerMeetingStoryArgs, 'storyId'>
  >
  ...
  updatedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>
  viewerMeetingMember?: Resolver<
    Maybe<ResolversTypes['PokerMeetingMember']>,
    ParentType,
    ContextType
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type PokerMeetingMemberResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['PokerMeetingMember'] = ResolversParentTypes['PokerMeetingMember']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  isCheckedIn?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>
...
export type PokerMeetingSettingsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['PokerMeetingSettings'] = ResolversParentTypes['PokerMeetingSettings']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  meetingType?: Resolver<ResolversTypes['MeetingTypeEnum'], ParentType, ContextType>
  organizationTemplates?: Resolver<
    ResolversTypes['PokerTemplateConnection'],
    ParentType,
    ContextType,
    RequireFields<PokerMeetingSettingsOrganizationTemplatesArgs, 'first'>
  >
  phaseTypes?: Resolver<Array<ResolversTypes['NewMeetingPhaseTypeEnum']>, ParentType, ContextType>
  publicTemplates?: Resolver<
    ResolversTypes['PokerTemplateConnection'],
    ParentType,
    ContextType,
    RequireFields<PokerMeetingSettingsPublicTemplatesArgs, 'first'>
  >
...
export type PokerTemplateResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['PokerTemplate'] = ResolversParentTypes['PokerTemplate']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  dimension?: Resolver<
    ResolversTypes['TemplateDimension'],
    ParentType,
    ContextType,
    RequireFields<PokerTemplateDimensionArgs, 'dimensionId'>
  >
...
export type PokerTemplateConnectionResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['PokerTemplateConnection'] = ResolversParentTypes['PokerTemplateConnection']
> = {
...
export type PokerTemplateEdgeResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['PokerTemplateEdge'] = ResolversParentTypes['PokerTemplateEdge']
> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
> = {
  company?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<QueryCompanyArgs>
  >
  dailyPulse?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<QueryDailyPulseArgs, 'after' | 'channelId' | 'email'>
  >
  logins?: Resolver<
    ResolversTypes['LoginsPayload'],
    ParentType,
    ContextType,
    RequireFields<QueryLoginsArgs, 'isActive'>
  >
  ...
  signups?: Resolver<
    ResolversTypes['SignupsPayload'],
    ParentType,
    ContextType,
    RequireFields<QuerySignupsArgs, 'isActive'>
  >
  suCountTiersForUser?: Resolver<
    Maybe<ResolversTypes['UserTiersCount']>,
    ParentType,
    ContextType,
    RequireFields<QuerySuCountTiersForUserArgs, 'userId'>
  >
  suOrgCount?: Resolver<
    Maybe<ResolversTypes['Int']>,
    ParentType,
    ContextType,
    RequireFields<QuerySuOrgCountArgs, 'minOrgSize' | 'tier'>
  >
  suProOrgInfo?: Resolver<
    Maybe<Array<ResolversTypes['Organization']>>,
    ParentType,
    ContextType,
    RequireFields<QuerySuProOrgInfoArgs, 'includeInactive'>
  >
  suUserCount?: Resolver<
    Maybe<ResolversTypes['Int']>,
    ParentType,
    ContextType,
    RequireFields<QuerySuUserCountArgs, 'tier'>
  >
  ...
  users?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryUsersArgs, 'userIds'>
  >
}
...
> = {
  __resolveType: TypeResolveFn<
    'Comment' | 'RetroReflection' | 'TeamPromptResponse',
    ParentType,
    ContextType
  >
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type ReactjiResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['Reactji'] = ResolversParentTypes['Reactji']
> = {
...
export type ReflectPhaseResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ReflectPhase'] = ResolversParentTypes['ReflectPhase']
> = {
...
export type ReflectPromptResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ReflectPrompt'] = ResolversParentTypes['ReflectPrompt']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type ReflectTemplateResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ReflectTemplate'] = ResolversParentTypes['ReflectTemplate']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  isActive?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>
...
export type ReflectTemplateConnectionResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ReflectTemplateConnection'] = ResolversParentTypes['ReflectTemplateConnection']
> = {
...
export type ReflectTemplateEdgeResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ReflectTemplateEdge'] = ResolversParentTypes['ReflectTemplateEdge']
> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type RemoveAllSlackAuthsPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['RemoveAllSlackAuthsPayload'] = ResolversParentTypes['RemoveAllSlackAuthsPayload']
> = {
  __resolveType: TypeResolveFn<
    'ErrorPayload' | 'RemoveAllSlackAuthsSuccess',
    ParentType,
    ContextType
  >
}

export type RemoveAllSlackAuthsSuccessResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['RemoveAllSlackAuthsSuccess'] = ResolversParentTypes['RemoveAllSlackAuthsSuccess']
> = {
...
export type RepoIntegrationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['RepoIntegration'] = ResolversParentTypes['RepoIntegration']
> = {
  __resolveType: TypeResolveFn<
    'JiraRemoteProject' | 'JiraServerRemoteProject',
    ParentType,
    ContextType
  >
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type RepoIntegrationQueryPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['RepoIntegrationQueryPayload'] = ResolversParentTypes['RepoIntegrationQueryPayload']
> = {
  error?: Resolver<Maybe<ResolversTypes['StandardMutationError']>, ParentType, ContextType>
...
export type RetroDiscussStageResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['RetroDiscussStage'] = ResolversParentTypes['RetroDiscussStage']
> = {
  discussion?: Resolver<ResolversTypes['Discussion'], ParentType, ContextType>
  discussionId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  endAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>
...
export type RetroReflectionResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['RetroReflection'] = ResolversParentTypes['RetroReflection']
> = {
  ...
  reactjis?: Resolver<Array<ResolversTypes['Reactji']>, ParentType, ContextType>
  reflectionGroupId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  retroReflectionGroup?: Resolver<
    Maybe<ResolversTypes['RetroReflectionGroup']>,
    ParentType,
    ContextType
  >
  sortOrder?: Resolver<ResolversTypes['Float'], ParentType, ContextType>
...
export type RetroReflectionGroupResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['RetroReflectionGroup'] = ResolversParentTypes['RetroReflectionGroup']
> = {
  commentors?: Resolver<Maybe<Array<ResolversTypes['CommentorDetails']>>, ParentType, ContextType>
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type RetrospectiveMeetingResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['RetrospectiveMeeting'] = ResolversParentTypes['RetrospectiveMeeting']
> = {
  ...
  meetingMembers?: Resolver<
    Array<ResolversTypes['RetrospectiveMeetingMember']>,
    ParentType,
    ContextType
  >
  meetingNumber?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
  ...
  reflectionGroup?: Resolver<
    Maybe<ResolversTypes['RetroReflectionGroup']>,
    ParentType,
    ContextType,
    RequireFields<RetrospectiveMeetingReflectionGroupArgs, 'reflectionGroupId'>
  >
  reflectionGroups?: Resolver<
    Array<ResolversTypes['RetroReflectionGroup']>,
    ParentType,
    ContextType,
    Partial<RetrospectiveMeetingReflectionGroupsArgs>
  >
  ...
  updatedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>
  viewerMeetingMember?: Resolver<
    Maybe<ResolversTypes['RetrospectiveMeetingMember']>,
    ParentType,
    ContextType
  >
...
export type RetrospectiveMeetingMemberResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['RetrospectiveMeetingMember'] = ResolversParentTypes['RetrospectiveMeetingMember']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  isCheckedIn?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>
  meetingId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type RetrospectiveMeetingSettingsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['RetrospectiveMeetingSettings'] = ResolversParentTypes['RetrospectiveMeetingSettings']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  maxVotesPerGroup?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
  meetingType?: Resolver<ResolversTypes['MeetingTypeEnum'], ParentType, ContextType>
  organizationTemplates?: Resolver<
    ResolversTypes['ReflectTemplateConnection'],
    ParentType,
    ContextType,
    RequireFields<RetrospectiveMeetingSettingsOrganizationTemplatesArgs, 'first'>
  >
  phaseTypes?: Resolver<Array<ResolversTypes['NewMeetingPhaseTypeEnum']>, ParentType, ContextType>
  publicTemplates?: Resolver<
    ResolversTypes['ReflectTemplateConnection'],
    ParentType,
    ContextType,
    RequireFields<RetrospectiveMeetingSettingsPublicTemplatesArgs, 'first'>
  >
...
export type ServiceFieldResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ServiceField'] = ResolversParentTypes['ServiceField']
> = {
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  type?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type SignupsPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['SignupsPayload'] = ResolversParentTypes['SignupsPayload']
> = {
  byDomain?: Resolver<Array<ResolversTypes['DomainCountPayload']>, ParentType, ContextType>
  total?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type SlackIntegrationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['SlackIntegration'] = ResolversParentTypes['SlackIntegration']
> = {
...
export type SlackNotificationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['SlackNotification'] = ResolversParentTypes['SlackNotification']
> = {
...
export type StandardMutationErrorResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['StandardMutationError'] = ResolversParentTypes['StandardMutationError']
> = {
...
export type StripeFailPaymentPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['StripeFailPaymentPayload'] = ResolversParentTypes['StripeFailPaymentPayload']
> = {
  error?: Resolver<Maybe<ResolversTypes['StandardMutationError']>, ParentType, ContextType>
...
export type SuggestedActionResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['SuggestedAction'] = ResolversParentTypes['SuggestedAction']
> = {
  __resolveType: TypeResolveFn<
...
export type SuggestedActionCreateNewTeamResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['SuggestedActionCreateNewTeam'] = ResolversParentTypes['SuggestedActionCreateNewTeam']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  priority?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>
...
export type SuggestedActionInviteYourTeamResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['SuggestedActionInviteYourTeam'] = ResolversParentTypes['SuggestedActionInviteYourTeam']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  priority?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>
...
export type SuggestedActionTryActionMeetingResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['SuggestedActionTryActionMeeting'] = ResolversParentTypes['SuggestedActionTryActionMeeting']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  priority?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>
...
export type SuggestedActionTryRetroMeetingResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['SuggestedActionTryRetroMeeting'] = ResolversParentTypes['SuggestedActionTryRetroMeeting']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  priority?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>
...
export type SuggestedActionTryTheDemoResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['SuggestedActionTryTheDemo'] = ResolversParentTypes['SuggestedActionTryTheDemo']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  priority?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>
...
> = {
  ...
  isHighlighted?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    Partial<TaskIsHighlightedArgs>
  >
  meetingId?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>
  plaintextContent?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  replies?: Resolver<Array<ResolversTypes['Threadable']>, ParentType, ContextType>
...
export type TaskEditorDetailsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TaskEditorDetails'] = ResolversParentTypes['TaskEditorDetails']
> = {
  preferredName?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  userId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type TaskEstimateResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TaskEstimate'] = ResolversParentTypes['TaskEstimate']
> = {
...
export type TaskIntegrationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TaskIntegration'] = ResolversParentTypes['TaskIntegration']
> = {
...
> = {
  ...
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  createdBy?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>
  customPhaseItems?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['ReflectPrompt']>>>,
    ParentType,
    ContextType
  >
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  ...
  massInvitation?: Resolver<
    ResolversTypes['MassInvitation'],
    ParentType,
    ContextType,
    Partial<TeamMassInvitationArgs>
  >
  meeting?: Resolver<
    Maybe<ResolversTypes['NewMeeting']>,
    ParentType,
    ContextType,
    RequireFields<TeamMeetingArgs, 'meetingId'>
  >
  meetingSettings?: Resolver<
    ResolversTypes['TeamMeetingSettings'],
    ParentType,
    ContextType,
    RequireFields<TeamMeetingSettingsArgs, 'meetingType'>
  >
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  orgId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  organization?: Resolver<ResolversTypes['Organization'], ParentType, ContextType>
  scale?: Resolver<
    Maybe<ResolversTypes['TemplateScale']>,
    ParentType,
    ContextType,
    RequireFields<TeamScaleArgs, 'scaleId'>
  >
...
export type TeamIntegrationsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamIntegrations'] = ResolversParentTypes['TeamIntegrations']
> = {
...
export type TeamInvitationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamInvitation'] = ResolversParentTypes['TeamInvitation']
> = {
...
export type TeamInvitationPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamInvitationPayload'] = ResolversParentTypes['TeamInvitationPayload']
> = {
  meetingId?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>
...
export type TeamMeetingSettingsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamMeetingSettings'] = ResolversParentTypes['TeamMeetingSettings']
> = {
  __resolveType: TypeResolveFn<
...
> = {
  allAvailableRepoIntegrations?: Resolver<
    Array<ResolversTypes['RepoIntegration']>,
    ParentType,
    ContextType
  >
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  ...
  meetingMember?: Resolver<
    Maybe<ResolversTypes['MeetingMember']>,
    ParentType,
    ContextType,
    RequireFields<TeamMemberMeetingMemberArgs, 'meetingId'>
  >
  ...
  preferredName?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  repoIntegrations?: Resolver<
    ResolversTypes['RepoIntegrationQueryPayload'],
    ParentType,
    ContextType
  >
  tasks?: Resolver<
...
export type TeamMemberIntegrationAuthResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamMemberIntegrationAuth'] = ResolversParentTypes['TeamMemberIntegrationAuth']
> = {
  __resolveType: TypeResolveFn<
...
export type TeamMemberIntegrationAuthOAuth1Resolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamMemberIntegrationAuthOAuth1'] = ResolversParentTypes['TeamMemberIntegrationAuthOAuth1']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  isActive?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>
...
export type TeamMemberIntegrationAuthOAuth2Resolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamMemberIntegrationAuthOAuth2'] = ResolversParentTypes['TeamMemberIntegrationAuthOAuth2']
> = {
...
export type TeamMemberIntegrationAuthWebhookResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamMemberIntegrationAuthWebhook'] = ResolversParentTypes['TeamMemberIntegrationAuthWebhook']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  isActive?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>
...
export type TeamMemberIntegrationsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamMemberIntegrations'] = ResolversParentTypes['TeamMemberIntegrations']
> = {
...
export type TeamNotificationResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamNotification'] = ResolversParentTypes['TeamNotification']
> = {
...
export type TeamPromptMeetingResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamPromptMeeting'] = ResolversParentTypes['TeamPromptMeeting']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  createdBy?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  createdByUser?: Resolver<ResolversTypes['User'], ParentType, ContextType>
  ...
  updatedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>
  viewerMeetingMember?: Resolver<
    Maybe<ResolversTypes['TeamPromptMeetingMember']>,
    ParentType,
    ContextType
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type TeamPromptMeetingMemberResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamPromptMeetingMember'] = ResolversParentTypes['TeamPromptMeetingMember']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  isCheckedIn?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>
  meetingId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type TeamPromptMeetingSettingsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamPromptMeetingSettings'] = ResolversParentTypes['TeamPromptMeetingSettings']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  meetingType?: Resolver<ResolversTypes['MeetingTypeEnum'], ParentType, ContextType>
  phaseTypes?: Resolver<Array<ResolversTypes['NewMeetingPhaseTypeEnum']>, ParentType, ContextType>
...
export type TeamPromptResponseResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamPromptResponse'] = ResolversParentTypes['TeamPromptResponse']
> = {
  content?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  plaintextContent?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type TeamPromptResponseStageResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamPromptResponseStage'] = ResolversParentTypes['TeamPromptResponseStage']
> = {
  discussion?: Resolver<ResolversTypes['Discussion'], ParentType, ContextType>
  discussionId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  endAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>
...
export type TeamPromptResponsesPhaseResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TeamPromptResponsesPhase'] = ResolversParentTypes['TeamPromptResponsesPhase']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  meetingId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  phaseType?: Resolver<ResolversTypes['NewMeetingPhaseTypeEnum'], ParentType, ContextType>
...
export type TemplateDimensionResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TemplateDimension'] = ResolversParentTypes['TemplateDimension']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type TemplateDimensionRefResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TemplateDimensionRef'] = ResolversParentTypes['TemplateDimensionRef']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type TemplateScaleResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TemplateScale'] = ResolversParentTypes['TemplateScale']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  dimensions?: Resolver<Array<ResolversTypes['TemplateDimension']>, ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type TemplateScaleRefResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TemplateScaleRef'] = ResolversParentTypes['TemplateScaleRef']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type TemplateScaleValueResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TemplateScaleValue'] = ResolversParentTypes['TemplateScaleValue']
> = {
...
export type ThreadableResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['Threadable'] = ResolversParentTypes['Threadable']
> = {
...
export type ThreadableConnectionResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ThreadableConnection'] = ResolversParentTypes['ThreadableConnection']
> = {
...
export type ThreadableEdgeResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['ThreadableEdge'] = ResolversParentTypes['ThreadableEdge']
> = {
...
export type TimelineEventCompletedActionMeetingResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TimelineEventCompletedActionMeeting'] = ResolversParentTypes['TimelineEventCompletedActionMeeting']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  interactionCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
...
export type TimelineEventCompletedRetroMeetingResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TimelineEventCompletedRetroMeeting'] = ResolversParentTypes['TimelineEventCompletedRetroMeeting']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  interactionCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
...
export type TimelineEventConnectionResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TimelineEventConnection'] = ResolversParentTypes['TimelineEventConnection']
> = {
...
export type TimelineEventEdgeResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TimelineEventEdge'] = ResolversParentTypes['TimelineEventEdge']
> = {
  cursor?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>
...
export type TimelineEventJoinedParabolResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TimelineEventJoinedParabol'] = ResolversParentTypes['TimelineEventJoinedParabol']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  interactionCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
...
export type TimelineEventPokerCompleteResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TimelineEventPokerComplete'] = ResolversParentTypes['TimelineEventPokerComplete']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  interactionCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
...
export type TimelineEventTeamCreatedResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['TimelineEventTeamCreated'] = ResolversParentTypes['TimelineEventTeamCreated']
> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  interactionCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
...
export type UpdateWatchlistPayloadResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['UpdateWatchlistPayload'] = ResolversParentTypes['UpdateWatchlistPayload']
> = {
  __resolveType: TypeResolveFn<'ErrorPayload' | 'UpdateWatchlistSuccess', ParentType, ContextType>
}

export type UpdateWatchlistSuccessResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['UpdateWatchlistSuccess'] = ResolversParentTypes['UpdateWatchlistSuccess']
> = {
  success?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type UpdatesPhaseResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['UpdatesPhase'] = ResolversParentTypes['UpdatesPhase']
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  meetingId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  phaseType?: Resolver<ResolversTypes['NewMeetingPhaseTypeEnum'], ParentType, ContextType>
...
export type UpdatesStageResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['UpdatesStage'] = ResolversParentTypes['UpdatesStage']
> = {
  endAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  isAsync?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>
...
> = {
  archivedTasks?: Resolver<
    Maybe<ResolversTypes['TaskConnection']>,
    ParentType,
    ContextType,
    RequireFields<UserArchivedTasksArgs, 'first' | 'teamId'>
  >
  archivedTasksCount?: Resolver<
    Maybe<ResolversTypes['Int']>,
    ParentType,
    ContextType,
    RequireFields<UserArchivedTasksCountArgs, 'teamId'>
  >
  company?: Resolver<Maybe<ResolversTypes['Company']>, ParentType, ContextType>
  createdAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>
  discussion?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<UserDiscussionArgs, 'id'>
  >
  email?: Resolver<ResolversTypes['Email'], ParentType, ContextType>
  featureFlags?: Resolver<ResolversTypes['UserFeatureFlags'], ParentType, ContextType>
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  identities?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['AuthIdentity']>>>,
    ParentType,
    ContextType
  >
  ...
  invoiceDetails?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<UserInvoiceDetailsArgs, 'invoiceId'>
  >
  invoices?: Resolver<
    Maybe<ResolversTypes['InvoiceConnection']>,
    ParentType,
    ContextType,
    RequireFields<UserInvoicesArgs, 'first' | 'orgId'>
  >
  ...
  meeting?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<UserMeetingArgs, 'meetingId'>
  >
  meetingCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
  meetingMember?: Resolver<
    Maybe<ResolversTypes['MeetingMember']>,
    ParentType,
    ContextType,
    RequireFields<UserMeetingMemberArgs, 'meetingId'>
  >
  ...
  newMeeting?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<UserNewMeetingArgs, 'meetingId'>
  >
  notifications?: Resolver<
    ResolversTypes['NotificationConnection'],
    ParentType,
    ContextType,
    RequireFields<UserNotificationsArgs, 'first'>
  >
  organization?: Resolver<
    Maybe<ResolversTypes['Organization']>,
    ParentType,
    ContextType,
    RequireFields<UserOrganizationArgs, 'orgId'>
  >
  organizationUser?: Resolver<
    Maybe<ResolversTypes['OrganizationUser']>,
    ParentType,
    ContextType,
    RequireFields<UserOrganizationUserArgs, 'orgId'>
  >
  ...
  similarReflectionGroups?: Resolver<
    Array<ResolversTypes['RetroReflectionGroup']>,
    ParentType,
    ContextType,
    RequireFields<UserSimilarReflectionGroupsArgs, 'reflectionGroupId' | 'searchQuery'>
  >
  ...
  tasks?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<UserTasksArgs, 'archived' | 'first' | 'includeUnassigned'>
  >
  team?: Resolver<
    Maybe<ResolversTypes['Team']>,
    ParentType,
    ContextType,
    RequireFields<UserTeamArgs, 'teamId'>
  >
  teamInvitation?: Resolver<
    ResolversTypes['TeamInvitationPayload'],
    ParentType,
    ContextType,
    Partial<UserTeamInvitationArgs>
  >
  teamMember?: Resolver<
    Maybe<ResolversTypes['TeamMember']>,
    ParentType,
    ContextType,
    RequireFields<UserTeamMemberArgs, 'teamId'>
  >
  teams?: Resolver<Array<ResolversTypes['Team']>, ParentType, ContextType>
  tier?: Resolver<ResolversTypes['TierEnum'], ParentType, ContextType>
  timeline?: Resolver<
    ResolversTypes['TimelineEventConnection'],
    ParentType,
    ContextType,
    RequireFields<UserTimelineArgs, 'first'>
  >
  ...
  userOnTeam?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<UserUserOnTeamArgs, 'userId'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type UserFeatureFlagsResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['UserFeatureFlags'] = ResolversParentTypes['UserFeatureFlags']
> = {
...
export type UserTiersCountResolvers<
  ContextType = InternalContext,
  ParentType extends ResolversParentTypes['UserTiersCount'] = ResolversParentTypes['UserTiersCount']
> = {
