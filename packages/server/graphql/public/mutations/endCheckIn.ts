...
const endCheckIn: MutationResolvers['endCheckIn'] = async (_source, {meetingId}, context, info) => {
  ...
  if (team.isOnboardTeam) {
    ...
    const removedSuggestedActionId = await removeSuggestedAction(teamLeadUserId, 'tryActionMeeting')
