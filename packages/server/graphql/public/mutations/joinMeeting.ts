...
// TODO: CheckInStage, TeamPromptResponseStage, UpdatesStage are from the deprecated /database directory
...
const joinMeeting: MutationResolvers['joinMeeting'] = async (
  _source,
  {meetingId},
