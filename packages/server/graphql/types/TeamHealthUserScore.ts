...
const TeamHealthUserScore = new GraphQLObjectType<any, GQLContext>({
  name: 'TeamHealthUserScore',
  description: 'The user and their vote',
  fields: () => ({
    id: {
    ...
    userId: {
      type: new GraphQLNonNull(GraphQLID),
      description: 'The userId for this score'
    },
    user: {
      type: new GraphQLNonNull(User),
      description: 'The user for this score',
