...
export type MattermostNotificationAuth = IntegrationProviderMattermost

export const MattermostNotificationHelper: NotificationIntegrationHelper<
  MattermostNotificationAuth
> = (notificationChannel) => ({
