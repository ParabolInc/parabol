...
import GcalOAuth2Manager from '../GcalOAuth2Manager'

const mockedAuthorize = authorizeOAuth2 as jest.MockedFunction<typeof authorizeOAuth2>
const mockedFetch = fetch as jest.MockedFunction<typeof fetch>

describe('GcalOAuth2Manager.authorize', () => {
  const manager = new GcalOAuth2Manager('cid', 'secret', 'https://oauth2.googleapis.com')
