...
const getTeamsByOrgIdsQueryIR: any = {
  name: 'getTeamsByOrgIdsQuery',
  params: [
    {
      name: 'orgIds',
      codeRefs: {
        defined: {a: 42, b: 47, line: 3, col: 9},
        used: [{a: 100, b: 105, line: 6, col: 18}]
      },
 ...
 * ```
 */
export const getTeamsByOrgIdsQuery = new PreparedQuery<
  IGetTeamsByOrgIdsQueryParams,
  IGetTeamsByOrgIdsQueryResult
>(getTeamsByOrgIdsQueryIR)
