...
const getPollsByIdQueryIR: any = {"name":"getPollsByIdQuery","params":[{"name":"ids","codeRefs":{"defined":{"a":38,"b":40,"line":3,"col":9},"used":[{"a":88,"b":90,"line":6,"col":13}]},"transform":{"type":"array_spread"}}],"usedParamSet":{"ids":true},"statement":{"body":"SELECT * FROM \"Poll\"\nWHERE id in :ids","loc":{"a":54,"b":90,"line":5,"col":0}}};
 ...
 * ```
 */
export const getPollsByIdQuery = new PreparedQuery<IGetPollsByIdQueryParams,IGetPollsByIdQueryResult>(getPollsByIdQueryIR);
