...
const getPollOptionsByPollIdQueryIR: any = {"name":"getPollOptionsByPollIdQuery","params":[{"name":"pollIds","codeRefs":{"defined":{"a":48,"b":54,"line":3,"col":9},"used":[{"a":114,"b":120,"line":6,"col":19}]},"transform":{"type":"array_spread"}}],"usedParamSet":{"pollIds":true},"statement":{"body":"SELECT * FROM \"PollOption\"\nWHERE \"pollId\" in :pollIds","loc":{"a":68,"b":120,"line":5,"col":0}}};
 ...
 * ```
 */
export const getPollOptionsByPollIdQuery = new PreparedQuery<IGetPollOptionsByPollIdQueryParams,IGetPollOptionsByPollIdQueryResult>(getPollOptionsByPollIdQueryIR);
