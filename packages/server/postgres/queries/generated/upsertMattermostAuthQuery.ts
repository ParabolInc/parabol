...
/** Query 'UpsertMattermostAuthQuery' is invalid, so its result is assigned type 'never' */
export type IUpsertMattermostAuthQueryResult = never;

/** Query 'UpsertMattermostAuthQuery' is invalid, so its parameters are assigned type 'never' */
export type IUpsertMattermostAuthQueryParams = never;
