...
const archiveTeamsByTeamIdsQueryIR: any = {
  name: 'archiveTeamsByTeamIdsQuery',
  params: [
    {
      name: 'ids',
      codeRefs: {
        defined: {a: 47, b: 49, line: 3, col: 9},
        used: [{a: 118, b: 120, line: 8, col: 9}]
      },
 ...
 * ```
 */
export const archiveTeamsByTeamIdsQuery = new PreparedQuery<
  IArchiveTeamsByTeamIdsQueryParams,
  IArchiveTeamsByTeamIdsQueryResult
>(archiveTeamsByTeamIdsQueryIR)
