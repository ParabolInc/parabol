...
export interface IGetPollsByDiscussionIdQueryParams {
  discussionIds: Array<string | null | void>
}
...
const getPollsByDiscussionIdQueryIR: any = {
  name: 'getPollsByDiscussionIdQuery',
  params: [
    {
      name: 'discussionIds',
      codeRefs: {
        defined: {a: 48, b: 60, line: 3, col: 9},
        used: [{a: 120, b: 132, line: 6, col: 25}]
      },
      transform: {type: 'array_spread'}
    }
  ],
  usedParamSet: {discussionIds: true},
  statement: {
    body: 'SELECT * FROM "Poll"\nWHERE "discussionId" in :discussionIds',
    loc: {a: 74, b: 132, line: 5, col: 0}
  }
}
 ...
 * ```
 */
export const getPollsByDiscussionIdQuery = new PreparedQuery<
  IGetPollsByDiscussionIdQueryParams,
  IGetPollsByDiscussionIdQueryResult
>(getPollsByDiscussionIdQueryIR)
