...
const getTeamMemberIntegrationAuthQueryIR: any = {
  name: 'getTeamMemberIntegrationAuthQuery',
  params: [
    {
      name: 'teamId',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 108, b: 113, line: 5, col: 18}]}
    },
    {
      name: 'userId',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 131, b: 136, line: 6, col: 16}]}
    },
    {
      name: 'service',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 155, b: 161, line: 7, col: 17}]}
    }
  ],
  usedParamSet: {teamId: true, userId: true, service: true},
  statement: {
    body: 'SELECT * FROM "TeamMemberIntegrationAuth"\nWHERE "teamId" = :teamId\nAND "userId" = :userId\nAND "service" = :service\nAND "isActive" = TRUE',
    loc: {a: 48, b: 183, line: 4, col: 0}
  }
}
 ...
 * ```
 */
export const getTeamMemberIntegrationAuthQuery = new PreparedQuery<
  IGetTeamMemberIntegrationAuthQueryParams,
  IGetTeamMemberIntegrationAuthQueryResult
>(getTeamMemberIntegrationAuthQueryIR)
