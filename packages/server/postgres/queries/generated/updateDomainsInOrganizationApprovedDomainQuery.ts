...
const updateDomainsInOrganizationApprovedDomainQueryIR: any = {"name":"updateDomainsInOrganizationApprovedDomainQuery","params":[{"name":"oldDomain","transform":{"type":"scalar"},"codeRefs":{"used":[{"a":127,"b":135,"line":5,"col":30},{"a":166,"b":174,"line":6,"col":16}]}},{"name":"newDomain","transform":{"type":"scalar"},"codeRefs":{"used":[{"a":139,"b":147,"line":5,"col":42}]}}],"usedParamSet":{"oldDomain":true,"newDomain":true},"statement":{"body":"UPDATE \"OrganizationApprovedDomain\"\nSET domain = replace(domain, :oldDomain, :newDomain)\nWHERE domain = :oldDomain","loc":{"a":61,"b":174,"line":4,"col":0}}};
