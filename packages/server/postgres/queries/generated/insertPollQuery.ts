...
const insertPollQueryIR: any = {
  name: 'insertPollQuery',
  params: [
    {
      name: 'createdById',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 158, b: 168, line: 12, col: 3}]}
    },
    {
      name: 'discussionId',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 174, b: 185, line: 13, col: 3}]}
    },
    {
      name: 'teamId',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 191, b: 196, line: 14, col: 3}]}
    },
    {
      name: 'meetingId',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 202, b: 210, line: 15, col: 3}]}
    },
    {
      name: 'threadSortOrder',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 216, b: 230, line: 16, col: 3}]}
    },
    {
      name: 'title',
      transform: {type: 'scalar'},
      codeRefs: {used: [{a: 236, b: 240, line: 17, col: 3}]}
    }
  ],
  usedParamSet: {
    createdById: true,
 ...
 * ```
 */
export const insertPollQuery = new PreparedQuery<IInsertPollQueryParams, IInsertPollQueryResult>(
  insertPollQueryIR
)
