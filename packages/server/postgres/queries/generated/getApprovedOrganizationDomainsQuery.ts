...
const getApprovedOrganizationDomainsQueryIR: any = {
  name: 'getApprovedOrganizationDomainsQuery',
  params: [
    {
      name: 'orgIds',
      codeRefs: {
        defined: {a: 56, b: 61, line: 3, col: 9},
        used: [{a: 136, b: 141, line: 6, col: 18}]
      },
  ...
  statement: {
    body: 'SELECT * from "OrganizationApprovedDomain"\nWHERE "orgId" IN :orgIds AND "removedAt" IS NULL',
    loc: {a: 75, b: 165, line: 5, col: 0}
  }
}
 ...
 * ```
 */
export const getApprovedOrganizationDomainsQuery = new PreparedQuery<
  IGetApprovedOrganizationDomainsQueryParams,
  IGetApprovedOrganizationDomainsQueryResult
>(getApprovedOrganizationDomainsQueryIR)
