...
export interface IntegrationProviderMattermostWebhook extends Omit<IntegrationProviderWebhook, 'scope'> {
  service: 'mattermost'
  scope: Omit<IntegrationProviderScopeEnum, 'global'>
  scopeGlobal: false
}

export type IntegrationProviderMattermost = IntegrationProviderMattermostPlugin | IntegrationProviderMattermostWebhook
