 ...
 * `chown $USER rdb_test2.tar.gz && rm packages/cypress/fixtures/rdb_test.tar.gz && mv packages/cypress/fixtures/rdb_test2.tar.gz packages/cypress/fixtures/rdb_test.tar.gz`
 */
